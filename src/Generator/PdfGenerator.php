...
class PdfGenerator
{
    ...
    public function signe(PdfMerger $pdfMerger, Signature $signature): \TCPDF
    {
        return $signature->signe($pdfMerger);
    }

    public function signeTcpdfFpdi(\TCPDF $pdf, Signature $signature): \TCPDF
    {
        return $signature->signeTcpdfFpdi($pdf);
    }

    public function signes(PdfMerger $pdfMerger, array $signatures): \TCPDF
    {
